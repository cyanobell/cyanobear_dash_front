...
import { x, y, imageWidth, imageHeight, totalImages } from './CyanoBearModel'
...
<template>
    <div class="game-layer9" @mousedown="jump">
        <AnimImage :imageSrc="imageSrc" :imageWidth="imageWidth" :imageHeight="imageHeight" :totalImages="totalImages" :x="x" :y="y"
